...
class Network(object):
	...
	def backprop(self, x, y):
		...
		### the following statments are new contents in this file
		####recalculate the activations in the final layer
		tempNumerator = np.exp(zs[-1])
		tempDenominator = sum(tempNumerator)
		activations[-1] = tempNumerator / tempDenominator
        # backward pass
